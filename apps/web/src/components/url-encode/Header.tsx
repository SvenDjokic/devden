...
import { useNavigation } from '@/components/url-encode/navigation/NavigationProvider';
  ...
  return (
    ...
    <header className="border-b border-border bg-card/50 backdrop-blur-sm lg:hidden">
      <div className="px-4 sm:px-6">
        <h1 className="sr-only">URL Encoder/Decoder Online - Encode & Decode URLs</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm text-foreground">
                DevDen <span className="text-muted-foreground font-normal">URL Encode</span>
              </span>
            </div>
          </div>
