...
import { useNavigation } from '@/components/base64/navigation/NavigationProvider';
  ...
  return (
    ...
    <header className="border-b border-border bg-card/50 backdrop-blur-sm lg:hidden">
      <div className="px-4 sm:px-6">
        <h1 className="sr-only">Base64 Encoder/Decoder Online - Encode & Decode Base64</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-md bg-primary-500 flex items-center justify-center">
                <span className="text-white font-bold text-xs">64</span>
              </div>
              <span className="font-semibold text-sm text-foreground">
                DevDen <span className="text-muted-foreground font-normal">Base64</span>
              </span>
            </div>
          </div>
