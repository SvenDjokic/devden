...
import { useNavigation } from '@/components/json/navigation/NavigationProvider';
  ...
  return (
    ...
    <header className="border-b border-border bg-card/50 backdrop-blur-sm lg:hidden">
      <div className="px-4 sm:px-6">
        <h1 className="sr-only">JSON Formatter Online - Format, Beautify & Validate JSON</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm text-foreground">
                DevDen <span className="text-muted-foreground font-normal">JSON</span>
              </span>
            </div>
          </div>
